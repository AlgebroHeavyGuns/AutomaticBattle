...
public class ProductorEquiposG {
    ...
    static class HachaGranLeñador extends Arma{
        ...
        public HachaGranLeñador() {
            super("Hacha de Gran leñador", "axe.png", 450, 1, new Atributos(35,15,7,0,1,0,-1,0,1), TipoArma.HachaDosManos, Elemento.Comun, 1);
        }
    ...
    static class HachaDeBatalla extends Arma{
        ...
        public HachaDeBatalla() {
            super("Hacha de batalla", "axe2.png", 250, 3, new Atributos(25,15,5,0,0,0,0,0,0), TipoArma.HachaUnaMano, Elemento.Comun, 1);
    ...
    static class ArcoMediano extends Arma{
        ...
        public ArcoMediano() {
            super("Arco mediano", "arco2.png", 450, 1, new Atributos(10,20,5,1,1,0,1,0,2), TipoArma.Arco, Elemento.Comun, 5);

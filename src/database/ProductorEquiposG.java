...
public class ProductorEquiposG {
    ...
    static class HachaGranLeñador extends Arma{
        ...
        public HachaGranLeñador() {
            super("Hacha de Gran leñador", "axe.png", 425, 1, new Atributos(30,10,10,0,1,0,-1,0,1), TipoArma.HachaDosManos, Elemento.Comun, 1);
        }
    ...
    static class HachaDeBatalla extends Arma{
        ...
        public HachaDeBatalla() {
            super("Hacha de batalla", "axe2.png", 250, 3, new Atributos(20,10,7,0,0,0,0,0,0), TipoArma.HachaUnaMano, Elemento.Comun, 1);

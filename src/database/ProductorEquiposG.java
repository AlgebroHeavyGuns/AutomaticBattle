...
public class ProductorEquiposG {
    ...
    static class HachaGranLeñador extends Arma{
        ...
        public HachaGranLeñador() {
            super("Hacha de Gran leñador", "axe.png", 375, 1, new Atributos(40,10,9,0,1,0,-1,0,1), TipoArma.HachaDosManos, Elemento.Comun, 1);
        }
    ...
    static class EspadaColosal extends Arma{
        ...
        public EspadaColosal() {
            super("Espada colosal", "espada.png", 650, 3, new Atributos(60,15,15,0,2,1,-1,0,1), TipoArma.EspadaDosManos, Elemento.Comun, 1);
        }
    ...
    static class HachaDeBatalla extends Arma{
        ...
        public HachaDeBatalla() {
            super("Hacha de batalla", "axe2.png", 225, 3, new Atributos(20,10,6,0,0,0,0,0,0), TipoArma.HachaUnaMano, Elemento.Comun, 1);
    ...
    static class EspadaLigera extends Arma{
        ...
        public EspadaLigera() {
            super("Espada ligera", "espada2.png", 200, 3, new Atributos(25,15,5,0,0,0,1,0,0), TipoArma.EspadaUnaMano, Elemento.Comun, 1);
    ...
    static class ArcoMediano extends Arma{
        ...
        public ArcoMediano() {
            super("Arco mediano", "arco2.png", 450, 1, new Atributos(25,20,9,1,1,0,2,0,1), TipoArma.Arco, Elemento.Comun, 6);

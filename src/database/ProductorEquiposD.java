...
public class ProductorEquiposD {
    ...
    static class CorazaDeBatalla extends Equipable{
        ...
        public CorazaDeBatalla() {
            super("Coraza de batalla", "chest.png", 300, 0, new Atributos(80,0,0,0,5,3,0,0,0), TipoEquipo.Coraza);
    ...
    static class CorazaDeGuerra extends Equipable{
        ...
        public CorazaDeGuerra() {
            super("Coraza de guerra", "chest2.png", 550, 1, new Atributos(130,0,1,0,9,5,-1,0,0), TipoEquipo.Coraza);
    ...
    static class CascoDeBatalla extends Equipable{
        ...
        public CascoDeBatalla() {
            super("Casco de batalla", "casco.png", 200, 0, new Atributos(35,0,0,0,3,2,0,0,1), TipoEquipo.Casco);
    ...
    static class GuantesDeBatalla extends Equipable{
        ...
        public GuantesDeBatalla() {
            super("Guantes de batalla", "guante.png", 125, 0, new Atributos(20,10,1,0,2,1,0,0,0), TipoEquipo.Guantes);
        }
    ...
    static class AnilloDeVitalidad extends Equipable{
        ...
        public AnilloDeVitalidad() {
            super("AnilloDeVitalidad", "anillo1.png", 50, 0, new Atributos(20,0,0,0,0,0,0,0,0), TipoEquipo.Joyeria);
        }

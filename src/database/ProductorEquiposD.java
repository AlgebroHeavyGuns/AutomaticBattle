...
public class ProductorEquiposD {
    ...
    static class CorazaDeBatalla extends Equipable{
        ...
        public CorazaDeBatalla() {
            super("Coraza de batalla", "chest.png", 275, 0, new Atributos(65,0,0,0,4,2,0,0,0), TipoEquipo.Coraza);
    ...
    static class CorazaDeGuerra extends Equipable{
        ...
        public CorazaDeGuerra() {
            super("Coraza de guerra", "chest2.png", 550, 1, new Atributos(115,0,1,0,6,3,-1,0,0), TipoEquipo.Coraza);
    ...
    static class CascoDeBatalla extends Equipable{
        ...
        public CascoDeBatalla() {
            super("Casco de batalla", "casco.png", 150, 0, new Atributos(35,0,0,0,2,1,0,0,1), TipoEquipo.Casco);
